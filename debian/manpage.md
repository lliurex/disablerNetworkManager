% disablerNetworkManager(SECTION) | User Commands
%
% "Thu, 30 Jul 2026 13:23:41 +0200"
...
disablerNetworkManager - program to do something

# SYNOPSIS

**disablerNetworkManager** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**disablerNetworkManager** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **disablerNetworkManager** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**disablerNetworkManager** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    disablerNetworkManager. See **foo.conf**(5) for further details.
...
**disablerNetworkManager** provides some return codes, that can be used in scripts:
